...
- Backend S3 parcial, provider fixado no lockfile e CI de formatacao, validacao e 11 testes sem AWS real.
...
- Criar `oficina_staging` e `oficina_producao`, roles, grants e segredos de runtime por meio de bootstrap privado.
